...
enum WhatsNewCatalog {
    ...
    static let releases: [Release] = [
        ...
        Release(
            ...
            title: "Quoi de neuf",
            highlights: [
                "Menstruations — note un jour passé, ou toute une semaine en une seule action.",
                ...
                "Calendrier plus parlant — menstruations en ligne continue et points de traitement sur le calendrier du journal, avec légende.",
        ...
        Release(
            ...
            title: "Quoi de neuf",
            highlights: [
                "Menstruations — nouvel onglet pour noter tes menstruations, le spotting et tes symptômes.",
                "Jauges personnalisables — renomme, réordonne et ajoute tes propres curseurs dans le journal et les menstruations.",
                "Corrélations — ton humeur en regard de tes prises, changements de traitement et jours de menstruations.",
